 ...
 */
public class ZxQcAdapter extends BaseAdapter{
    Context context;
    List<QcGridData> dataGrids;
    LruUtils lruUtils;
    File file ;
    File[] files;
    Intent intent;
    ...
    public ZxQcAdapter(Context context, List<QcGridData> dataGrids) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final String webUrl=dataGrids.get(i).getDoc_url();
